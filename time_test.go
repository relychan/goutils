...
var jsonTests = []struct {
	...
	{Date(9999, 4, 12, 23, 20, 50, 520*1e6, time.UTC), `"9999-04-12T23:20:50.52Z"`, `"9999-04-12T23:20:50.52Z"`},
	{Date(9999, 4, 12, 23, 20, 50, 520*1e6, time.UTC), `"9999-04-12 23:20:50.52"`, `"9999-04-12T23:20:50.52Z"`},
	{Date(9999, 4, 12, 0, 0, 0, 0, time.UTC), `"9999-04-12"`, `"9999-04-12T00:00:00Z"`},
	{Date(0, 1, 1, 0, 0, 0, 1, time.FixedZone("", 1*60)), `"0000-01-01T00:00:00.000000001+00:01"`, `"0000-01-01T00:00:00.000000001+00:01"`},
	{Date(2020, 1, 1, 0, 0, 0, 0, time.FixedZone("", 23*60*60+59*60)), `"2020-01-01T00:00:00+23:59"`, `"2020-01-01T00:00:00+23:59"`},
}
...
func TestTimeJSON(t *testing.T) {
	for _, tt := range jsonTests {
		...
		} else if err = json.Unmarshal([]byte(tt.input), &jsonTime); err != nil {
